...
CREATE TABLE IF NOT EXISTS event (id INT AUTO_INCREMENT PRIMARY KEY, title VARCHAR(255) NOT NULL, description TEXT, main_image TEXT, images JSON, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP);
